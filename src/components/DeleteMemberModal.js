...
function DeleteMemberModal({
  ...
  const deletememberInfo = members.filter(member => member.id === deletemember);
  ...
  return (
    <ModalBackground visible={visible}>
      <ModalTemplate visible={visible}>
        ...
        <ContentText>님을 가족 구성원에서 삭제하시겠습니까?</ContentText>
        <br />
        <br />
        <SaveTxt onClick={onRemove}>네</SaveTxt>
