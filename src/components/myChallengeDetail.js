    ...
    return ( 
        <Fragment>
            <Headers style={{height : "7.5vh", lineHeight : 0, background : "white"}}>
                <Logo>
                    <img src ={logoImage} alt ="default" height = "70%" style={{marginRight : "4%"}}/>
                    <QuestionMark>
            ...
            <Contents>
                ...
                <Certification>
                    ...
                    <div style={{ margin : "1% 5%", height : "75%", backgroundColor : "#ccc", borderRadius : "5px"}}>

                        <div style={{fontWeight : "bolder", textAlign : "center", fontSize : "1%", paddingTop : "5%"}}>
                            '동생'과 함께하는 저녁식사
                        </div>
                    ...
                    <div style={{ borderTop: "1px solid lightgray", borderBottom: "1px solid lightgray", height : "23.5%"}}>
                        hi
                    </div>
